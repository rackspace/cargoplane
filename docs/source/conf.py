...
htmlhelp_basename = 'cargoplanedoc'
...
latex_documents = [
    (master_doc, 'cargoplane.tex', u'Cargoplane Documentation',
...
man_pages = [
    (master_doc, 'cargoplane', u'Cargoplane Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'cargoplane', u'Cargoplane Documentation',
     author, 'cargoplane', 'Serverless publish/subscribe for webapps and AWS',
     'Miscellaneous'),
]
